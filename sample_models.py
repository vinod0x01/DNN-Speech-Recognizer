...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for layer in range(recur_layers - 1):
        ...
        rnn = GRU(units, activation="relu",return_sequences=True, implementation=2, name=layer_name) (rnn_input_for_next_rnn)
...
def final_model (input_dim = 161, filters = 220, kernel_size = 11, conv_stride = 2, conv_border_mode='valid', units=200, output_dim=29):
